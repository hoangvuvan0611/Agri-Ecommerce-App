...
export default function HeroSection () {
    ...
    return (
        <div className="grid grid-cols-12 gap-1 my-8 bg-cover bg-center h-[450] w-full rounded-xl relative">
            {/* Background image */}
            ...
            {/* Left */}
            <div className="col-span-8 bg-white p-8 grid-cols-8 relative">
